...
import '../nearby_services/nearby_services_screen.dart' show nearbyServicesStreamProvider;
...
Color _zoneColor(String type, String severity) {
  final base = switch (type) {
    ...
    MapZoneType.traffic => Colors.amber,
    _ => Colors.grey,
  };
        ...
        actions: [
          IconButton(
            icon: Icon(
              ...
              color: _isHeatmapEnabled ? AppColors.accentCyan : Colors.white,
            ),
                          ...
                          children: [
                            Icon(
                              ...
                              color: _routeResult == null
                                  ? Colors.green
                                  : (_routeResult!.hasDangerZones ? AppColors.emergencyRed : Colors.green),
                              size: 24,
                            ),
